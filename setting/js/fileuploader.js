...
qq.FileUploaderBasic = function(o){
	...
	this._options = {
		...
		// messages
		messages: {
			typeError: "{file} 不合法的升级包. 升级包后缀名应为 {extensions}.",
			sizeError: "{file} 太大, 最大文件大小为 {sizeLimit}.",
			minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
			emptyError: "{file} 为空，请选择正确的文件",
			noFilesError: "没有文件可上传.",
			onLeave: "文件正在上传，离开此页会导致上传失败."
		},
...
qq.FileUploader = function(o){
	...
	this._options.fileTemplate = this._options.fileTemplate.replace(/\{succUploadtext\}/g, this._options.succUploadText);
